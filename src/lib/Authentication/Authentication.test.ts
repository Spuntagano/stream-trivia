...
test('able to set a token', () => {
    auth.setToken(normalToken, 'U12345678', '12345678', '12345678');
...
describe('makeCall tests', () => {
    test('able to call a test URL', async () => {
        let response:any = await auth.makeCall('https://twitch.tv/');
    ...
    test('rejects on invalid response', () => {
        auth.setToken('abc123', 'U12345678', '12345678', '12345678');
...
describe('moderator tests', () => {
    test('returns valid mod status', () => {
        auth.setToken(modToken, 'ABC123', '12345678', '12345678');
        expect(auth.isModerator()).toEqual(true);

        auth.setToken(normalToken, 'ABC123', '12345678', '12345678');
