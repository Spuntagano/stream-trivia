    ...
    render() {
        ...
        return (
            <div className="questions">
                {!hasAnswered && timeLeft > 0 && <h6 className="question">{atob(questions[currentQuestion].question)}</h6>}
                {!hasAnswered && timeLeft > 0 && this.renderChoices()}
                {hasAnswered && timeLeft > 0 && <h6 className="sure">Are you sure? monkaS</h6>}
                {!hasAnswered && timeLeft > 0 && <h6 className="timer">{timeLeft}</h6>}
